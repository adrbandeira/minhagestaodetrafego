  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-1 -right-1 bg-danger text-white text-[10px] font-bold min-w-[20px] h-[20px] px-1 rounded-full flex items-center justify-center shadow-lg shadow-danger/30 border-2 border-background">
            {unread > 9 ? '9+' : unread}
          </span>
        )}
      </button>
